...
API_KEY = "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"
openai.api_key = API_KEY
openai.organization = "org-xsfHQ6Epu1KSsRioKoU6QPRU"
model_id = 'gpt-4-0613'
op_dict={}
...
def ask_questions(data):
    ...
    for key,value in data.items():
        ...
        # print(messages)
                # questions.append(pred)
    # return questions,gpt_op
    # return questions
